...
// Matrix rain as a PURE BACKGROUND: canvas fixed behind; no darkening.
(function(){
  function assetsBase(){
  ...
  Object.assign(c.style,{
    ...
    zIndex:'0', pointerEvents:'none', background:'black'
  });
  // put canvas as the very first child of <body>
  document.addEventListener('DOMContentLoaded', ()=> document.body.prepend(c));
  ...
  // No cumulative dark overlay; just clear each frame so content never dims.
  function draw(){
